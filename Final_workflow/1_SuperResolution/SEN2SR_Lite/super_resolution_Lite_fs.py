...
DEFAULT_OUTPUT_DIR = (
    ...
    "pKq003_SR4LC_Data/outputs/S2_SRLite/FS"
)

FULL_MODEL_PATH = (
    "/teamspace/studios/this_studio/"
    "SR4LC/model/SEN2SRLite"
)
...
def build_output_path(input_10m_tif, output_dir=DEFAULT_OUTPUT_DIR):
    ...
    return output_dir / f"SRL_FS_{base_name}.tif"
...
def run_sen2srlite_full_spectral(
    input_10m_tif,
    input_20m_tif,
    ...
    print("Loading SEN2SRLite Full Spectral model...")
    ...
    print("Running SEN2SRLite Full Spectral...")
